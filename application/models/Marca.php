...
class Application_Model_Marca
{
    ...
    public function getDbTable() {
        $this->dbTable = new Application_Model_DbTable_Table(array('name' => 'marca'));
    ...
    public function novo($array) {
        ...
        $array['marca_cadastro'] = date('Y-m-d H:i:s');
    ...
    public function salvar($array, $id) {
        ...
        $array['marca_update'] = date('Y-m-d H:i:s');
