...
class EstoqueController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->model = new Application_Model_Estoque();
        $this->form = new Application_Form_Estoque();
        $this->formNovo = new Application_Form_Estoque();
        $this->link = 'estoque';
        $this->idBd = 'estoque_id';
