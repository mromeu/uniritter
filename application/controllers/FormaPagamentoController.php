...
class FormaPagamentoController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->model = new Application_Model_FormaPagamento();
        $this->form = new Application_Form_FormaPagamento();
        $this->formNovo = new Application_Form_FormaPagamento();
        $this->link = 'forma-pagamento';
        $this->idBd = 'forma_pagamento_id';
