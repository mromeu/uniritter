...
class Twitter_Form extends Zend_Form
{
	...
	protected function _getElementDecorators()
	{
		return array(
			"ViewHelper",
			array("Errors", array("placement" => "append", 'class' => 'text-danger text-left error')),
			array("Description", array("tag" => "span", "class" => "help-block")),
			array(array("innerwrapper" => "HtmlTag"), array("tag" => "div")),
			array("Label", array("class" => "col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label")),
