...
require_once 'Zend/Service/Mailchimp/Folders.php';
require_once 'Zend/Service/Mailchimp/Templates.php';
require_once 'Zend/Service/Mailchimp/Users.php';
require_once 'Zend/Service/Mailchimp/Helper.php';
require_once 'Zend/Service/Mailchimp/Mobile.php';
require_once 'Zend/Service/Mailchimp/Conversations.php';
require_once 'Zend/Service/Mailchimp/Ecomm.php';
require_once 'Zend/Service/Mailchimp/Neapolitan.php';
require_once 'Zend/Service/Mailchimp/Lists.php';
require_once 'Zend/Service/Mailchimp/Campaigns.php';
require_once 'Zend/Service/Mailchimp/Vip.php';
require_once 'Zend/Service/Mailchimp/Reports.php';
require_once 'Zend/Service/Mailchimp/Gallery.php';
require_once 'Zend/Service/Mailchimp/Goal.php';
require_once 'Zend/Service/Mailchimp/Exceptions.php';
//require_once 'Zend/Service/Rest/Client.php';

class Zend_Service_MailChimp {
